...
% Initialization
totalframe=60;
locallattice_A0=zeros(totalframe,2);
locallattice_B0=zeros(totalframe,2);
A0_coor=zeros(totalframe,1);
B0_coor=zeros(totalframe,1);
rotationdegree=zeros(totalframe,1);
translationinpixels=zeros(totalframe,2);
elapsedtime=zeros(totalframe,1);
currentframeno=0;


for referenceframeno = 1:totalframe
    ...
    [locallattice_A0(referenceframeno,:),locallattice_B0(referenceframeno,:),...
        A0_coor(referenceframeno,:),B0_coor(referenceframeno,:),rotationdegree(referenceframeno,:),...
        translationinpixels(referenceframeno,:),elapsedtime(referenceframeno,:)]...
